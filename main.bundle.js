...
let domUpdates = {
  ...
  addToDom(recipeInfo, shortRecipeName) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('main').append(cardHtml);
  },
  ...
  displayPantryInfo(allIngredients, pantry) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pantry-list').empty();
    ...
    pantry.forEach(i => {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".pantry-list").append(ingredientHtml);
    });
  },
  ...
  toggleMenu() {
    ...
    if (this.menuOpen) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.drop-menu').css("display", "block");
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.drop-menu').css("display", "none");
    }
  },
  ...
  generateRecipeTitle(recipe, ingredients) {
    let recipeTitle = `
      ...
      <h4>Ingredients</h4>
      <ul>${ingredients}</ul>`
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-instructions').append(recipeTitle);
  },

  addRecipeImage(recipe) {
    let background = recipe.image;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#recipe-title").css("background-image", "url('" + background + "')");
  },
  ...
  generateInstructions(recipe) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-instructions').append("<h4>Instructions</h4>");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-instructions').append(`<ol>${instructionsList}</ol>`);
  },

  exitRecipe(fullRecipeInfo) {
    fullRecipeInfo.firstChild
      && fullRecipeInfo.removeChild(fullRecipeInfo.firstChild);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-instructions').css('display', 'none');
  ...
  updateRecipeModal(recipe, missingIngredientInfo, ingredientsEnabled, cookButtonEnabled, missingIngredientsTotal) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.missing-ingredient-title, .recipe-missing-ingredients').remove();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(`button#${recipe.id}`).remove();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(`button[data-id='${recipe.id}']`).remove();

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-instructions').append("<h4 class='missing-ingredient-title'>Missing Ingredients</h4>");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-instructions').append(`<ul class="recipe-missing-ingredients">${missingIngredientInfo}</ul>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-instructions').append(`<button id="${recipe.id}" class='purchase-ingredients' ${ingredientsEnabled}>Buy Missing Ingredients <span>${missingIngredientsTotal}</span></button>`);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-instructions').append(`<button data-id="${recipe.id}" class='cook-recipe' ${cookButtonEnabled}>Cook Recipe</button>`);
  }
...
module.exports = "images/chef-1.png";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
let ingredientsDB = __webpack_require__(/*! ../src/data/ingredient-data */ "./src/data/ingredient-data.js");
...
/* harmony import */ var _images_apple_logo_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images/apple-logo.png */ "./src/images/apple-logo.png");
/* harmony import */ var _images_apple_logo_png__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_images_apple_logo_png__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _images_apple_logo_outline_png__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_images_apple_logo_outline_png__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _images_seasoning_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/seasoning.png */ "./src/images/seasoning.png");
/* harmony import */ var _images_seasoning_png__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_images_seasoning_png__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _images_cookbook_png__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_images_cookbook_png__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _images_chef_1_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./images/chef-1.png */ "./src/images/chef-1.png");
/* harmony import */ var _images_chef_1_png__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_images_chef_1_png__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _css_styles_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./css/styles.scss */ "./src/css/styles.scss");
...
/* harmony import */ var _recipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./recipe */ "./src/recipe.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-all-btn').on("click", showAllRecipes);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter-btn').on("click", findCheckedTags);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('main').on("click", recipeCardEventHandler);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.my-pantry-btn').on("click", _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].toggleMenu);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.saved-recipes-btn').on("click", showSavedRecipes);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-btn').on("click", searchRecipes);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-pantry-recipes-btn').on("click", findCheckedPantryBoxes);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#search').on("submit", pressEnterSearch);
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#search').on("submit", pressEnterSearch);
...
function generateUser() {
  ...
  fetch('https://fe-apps.herokuapp.com/api/v1/whats-cookin/1911/users/wcUsersData')
    ...
    .then(data => {
      ...
      user = new _user__WEBPACK_IMPORTED_MODULE_9__["default"](data.wcUsersData[randNum]);

      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].displayFirstName(user);
      fetchIngredientInfo();
    })
...
function fetchIngredientInfo() {
  fetch('https://fe-apps.herokuapp.com/api/v1/whats-cookin/1911/ingredients/ingredientsData')
    ...
    .then(data => {
      ...
      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].displayPantryInfo(allIngredients, user.pantry.ingredients.sort());
    })
    .catch(error => console.log(error.message));
}
...
const createCards = (data) => {
  data.recipeData.forEach(recipe => {
    let recipeInfo = new _recipe__WEBPACK_IMPORTED_MODULE_10__["default"](recipe);
    let shortRecipeName = recipeInfo.name;
    recipes.push(recipeInfo);
    if (recipeInfo.name.length > 40) {
      shortRecipeName = recipeInfo.name.substring(0, 40) + "...";
    }
    _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].addToDom(recipeInfo, shortRecipeName);
  });
}
...
const findTags = (data) => {
  ...
  _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].listTags(tags);
}

function findCheckedTags() {
  let checkedTags = [...jquery__WEBPACK_IMPORTED_MODULE_0___default()('.checked-tag:checked')];
...
function addToMyRecipes() {
  if (event.target.className === "card-apple-icon") {
    ...
    _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].exitRecipe(fullRecipeInfo);
...
function showSavedRecipes() {
  fetch('https://fe-apps.herokuapp.com/api/v1/whats-cookin/1911/recipes/recipeData')
    ...
    .then(data => {
      ...
      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].showMyRecipesBanner();
    })
...
function openRecipeInfo(event) {
  fetch('https://fe-apps.herokuapp.com/api/v1/whats-cookin/1911/recipes/recipeData')
    ...
    .then(data => {
      ...
      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].generateRecipeTitle(recipe, generateIngredients(recipe));
      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].addRecipeImage(recipe);
      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].generateInstructions(recipe);
      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].generateMissingIngredients(user, recipe, allIngredients);
...
function generateIngredients(recipe) {
  return recipe && recipe.ingredients.map(i => {
    ...
    return `<li>${_domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].capitalize(name)} (<strong>${i.quantity.amount} ${i.quantity.unit}</strong>)</li>`
  }).join("");
}
...
function showAllRecipes() {
  fetch('https://fe-apps.herokuapp.com/api/v1/whats-cookin/1911/recipes/recipeData')
    ...
    .then(data => {
      ...
      _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].showWelcomeBanner();
    })
    .catch(error => console.log(error.message));
}

function displayRecipes(recipesToDisplay) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.recipe-card').css('display', 'none');

  recipesToDisplay.forEach(recipe => {
    let domRecipe = '#' + recipe.id;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(domRecipe).css('display', 'block');
  });
}

// CREATE AND USE PANTRY
function findCheckedPantryBoxes() {
  let pantryCheckboxInfo = [...jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pantry-checkbox:checked')].map(item => item.dataset.id);
          ...
          .then(data => {
            fetch('https://fe-apps.herokuapp.com/api/v1/whats-cookin/1911/users/wcUsersData')
              ...
              .then(data => {
                user = new _user__WEBPACK_IMPORTED_MODULE_9__["default"](data.wcUsersData[randNum]);
                _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].generateMissingIngredients(user, recipe, allIngredients);
                _domUpdates__WEBPACK_IMPORTED_MODULE_1__["default"].displayPantryInfo(allIngredients, user.pantry.ingredients);
              })
